...
L['Default'] = true
L['Custom'] = true
L['Category Order'] = 'Kategorie Sortierung'
L['Create'] = 'Erstellen'
...
L['Hide Category'] = 'verstecke Kategorie'
...
L['Create/Edit'] = 'Erstellen/Ändern'
L['Quests'] = true
L['Items'] = true
L['Currencies'] = true
L['Saved'] = 'gespeichert'
...
L['Alive'] = true
L['Custom Labels'] = 'Spaltenbeschriftung'
...
L['Save Position'] = 'speicher Position'
L['Daily'] = 'täglich'
L['Biweekly'] = true
...
L['Empy Kaja\'Cola'] = 'leere Kaja\'Cola'
L['Kej'] = true
L['Undercoin'] = 'Lorenmünze'
L['Vintage Kaja\'Cola'] = 'Altertümliche Kaja\'Cola'
L['Spark - Omens'] = 'Funke der Omen'
L["Artisan's Acuity"] = 'Händchen fürs Kunsthandwerk'
L['Firelight Ruby'] = 'Feuerscheinrubin'
L['Coffer Key Shard'] = 'Kastenschlüsselsplitter'
L['Primeval Essence'] = 'Urzeitliche Essenz'
L['Zskera Vault Key'] = 'Schlüssel des Gewölbes von Zskera'
L["Artisan's Mettle"] = 'Eifer des Handwerkers'
L['Spark - Ingenuity'] = 'Funke der Genialität'
L['Spark - Shadowflame'] = 'Funke der Schattenflamme'
L["Unearthed Coin"] = 'Ausgegrabene duftende Münze'
L["Barter Brick"] = 'Tauschziegel'
L["Obsidian Flightstone"] = 'Obsidianflugstein'
L["Time Capsule"] = 'Zeitkapsel'
L['Dream Coalescence'] = 'Traumsprungvereinigung'
L['Dream Chrysalis'] = 'Traumsprungkokon'
L['Spark - Dreams'] = 'Funke der Träume'
L['Dreamseeds'] = 'Traumsaat'
L["Time Pod"] = 'Zeitkapsel'
L['Dream Cocoon'] = 'Traumsprung-Kokon'
L['Spark - Awakening'] = 'Funke der Erweckung'